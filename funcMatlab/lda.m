...
%       [Z,W]=lda(X,Y,r)
%       or
%       [Z,W]=lda(X,Y) , where r values by default is Number of classes
%       minus 1: C-1
% Input:
...
%        SB = SB +(LocalMu{i}-Global_Mu)*(LocalMu{i}-Global_Mu)';
        SW = SW+CovVal{i};
    end
